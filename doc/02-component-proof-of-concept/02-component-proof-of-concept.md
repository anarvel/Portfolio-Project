...
I am choosing the JobSearch component as I am more passionate about using my technical skills to create something that can benefit underrepresented people like immigrants. I think it will be more of an impactful project as there are not many other interfaces that are designed specifically for people with only certain documentation and language restrictions.
